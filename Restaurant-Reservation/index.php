...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>Shudh Restaurant & Cafe</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<p><br>Shudh Food Court is one of the recognized venture of Swati Group which has got experience of more than three decades in operating. In 2010 , the restaurant was awarded its first Michelin star and has retained it since.<br><br>
	The same year, the restaurant Cultural Centre in Delhi and was recently redesigned by award-winning architectural firm Divercity.In warmer months of the year the restaurant moves
	to the 2th floor of the building, offering a unique outdoor setting with panoramic view.<br><br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
...
?>
            ...
            <p class="text-right">Shudh Restaurant & Cafe<br><i class="fa fa-map-marker"></i>&nbsp; Delhi, <br>Delhi <br><br>email: info@domain.com<br>phone: +00 (123) 456 7890</p>
            </div>
